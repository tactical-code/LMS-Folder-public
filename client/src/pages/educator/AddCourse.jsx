                ...
                <div className='p-4'>
                  {chapter.chapterContent.map((lecture, lectureIndex)=>(
                    <div key={lectureIndex} className='flex justify-between items-center mb-2'>
                      ...
                      <span>{lectureIndex + 1} {lecture.lectureTitle} - {lecture.lectureDuration} mins - <a href={lecture.lectureUr1}
                      target="_blank" className="text-green-500">Link</a> - {lecture.isPreviewFree ? 'Free Preview' : 'Paid' }</span>
          ...
          showpopup && (
            <div className='fixed inset-0 flex items-center justify-center bg-gray-800 bg-opacity-50' >
              <div className="bg-white text-gray-700 p-4 rounded relative w-full max-w-80">
                ...
                <button onClick={addLecture} type='button' className='w-full bg-green-400 text-white px-4 py-2 rounded'>Add</button>
